...
void composite_3d(char const * f1, char const * f2, char const * out,
                  int delta);
...
image collapse_images_horz(image const * ims, int n);
image collapse_images_vert(image const * ims, int n);

void show_image(image p, char const * name);
void show_image_normalized(image im, char const * name);
void save_image_png(image im, char const * name);
void save_image(image p, char const * name);
void show_images(image const * ims, int n, char const * window);
void show_image_layers(image p, char const * name);
void show_image_collapsed(image p, char const * name);
...
image load_image_stb_resize(char const * filename, int w, int h, int c);
...
void test_resize(char const * filename);
#ifdef __cplusplus
}
#endif
