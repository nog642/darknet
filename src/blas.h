...
void pow_cpu(int N, float ALPHA, float const * X, int INCX, float * Y, int INCY);
void mul_cpu(int N, float const * X, int INCX, float * Y, int INCY);

void axpy_cpu(int N, float ALPHA, float const * X, int INCX, float * Y, int INCY);
void copy_cpu(int N, float const * X, int INCX, float * Y, int INCY);
...
void weighted_sum_cpu(float const * a, float const * b, float const * s, int num, float * c);
...
void backward_scale_channels_gpu(float * in_w_h_c_delta, int size, int channel_size, float * in_scales_c,
