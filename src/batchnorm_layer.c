...
layer make_batchnorm_layer(int const batch, int const w, int const h, int const c, int train)
{
...
void resize_batchnorm_layer(layer * const l, int const w, int const h)
{
    l->out_h = l->h = h;
    l->out_w = l->w = w;
